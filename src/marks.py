...
class Marks(Students):
    ...
    def addMark(self, id_student, name_student, surname_student, name_subject, name_mark, grade):
        if type(grade) != int:
            ...
            if self.keys.__contains__((str(id_student), name_student, surname_student)):
                valueSubjects = self.students[(str(id_student), name_student, surname_student)]["subjects"]
    ...
    def editMark(self, id_student, name_student, surname_student, name_subject, name_mark, grade):
        if type(grade) != int:
            raise TypeError("Bad_type_grade")
        else:
            if self.keys.__contains__((str(id_student), name_student, surname_student)):
